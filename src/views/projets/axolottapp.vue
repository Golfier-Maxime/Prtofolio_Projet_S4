    ...
    <div class="ml-4 mr-4 dark:text-white duration-700">
        ...
        <div class="ml-4 mr-4 lg:mx-20 ">
            ...
            <div>
                ...
                <p class="lg:mt-16 mt-8 lg:text-[18px]">Axolott est un projet universitaire de fin de première année en
                    groupe de
                    trois.
                    Le
                    but était de
            ...
            <div class="flex flex-col lg:flex-row justify-center lg:mt-20 lg:gap-16">
                ...
                <img src="/images/axolott_font.jpg" alt="" class="lg:w-[700px] rounded-lg mt-8 lg:mt-0">
            </div>
            <div class="flex justify-center lg:mt-20">
                <img src="/images/axolott_bye.png" alt="" class="lg:w-[400px] mt-16 lg:mt-0">
            </div>
        </div>
    </div>
</template>
